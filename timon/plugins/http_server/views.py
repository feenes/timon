...
KNOWN_ROUTES = {
    f"{BASE_URL_ROUTE}/resources/": str(
        "(GET) returns a list of all resources and their"
        " availability"),
    f"{BASE_URL_ROUTE}/queue/": "(GET) returns the queue as a list",
    f"{BASE_URL_ROUTE}/queue/lenght/": "(GET) returns the lenght of the queue",
    f"{BASE_URL_ROUTE}/queue/probe/<probename>/": (
        "(GET) search probe in queue"),
    f"{BASE_URL_ROUTE}/probes/<probename>/run/": (
        "(POST) force run the probename and returns "
        "the result"),
    f"{BASE_URL_ROUTE}/probes/<probename>/results/": (
        "(GET) returns the list of results ordered by datetime"
        " for a specific probename"
    ),
    f"{BASE_URL_ROUTE}/probes/<probename>/changes/": (
        "(GET) returns the list of last result status changes"
        " for a specific probename ordered by datetime"
    ),
    f"{BASE_URL_ROUTE}/rescheduler/probes/": (
...
@app.route(f"{BASE_URL_ROUTE}/resources/")
...
@app.route(f"{BASE_URL_ROUTE}/queue/")
async def get_queue():
    """
...
@app.route(f"{BASE_URL_ROUTE}/queue/length/")
...
@app.route(f"{BASE_URL_ROUTE}/queue/probe/<probename>/")
...
@app.route(f"{BASE_URL_ROUTE}/probes/<probename>/run/", methods=['POST'])
...
@app.route(f"{BASE_URL_ROUTE}/rescheduler/probes/", methods=['POST'])
...
@app.route(f"{BASE_URL_ROUTE}/probes/<probename>/results/", methods=['GET'])
...
@app.route(f"{BASE_URL_ROUTE}/probes/<probename>/changes/", methods=['GET'])
...
@app.route(f"{BASE_URL_ROUTE}/backport/hosts/", methods=['GET'])
async def get_hosts():
    """
...
@app.route(f"{BASE_URL_ROUTE}/backport/probes/", methods=['GET'])
...
@app.route(f"{BASE_URL_ROUTE}/backport/state/", methods=['GET'])
